...
public class NextWalkSelector {
     ...
     * 邻居的id
     */
    private List<Integer> _neighbors;
     ...
     */
    public NextWalkSelector(Algorithm algorithm, List<Integer> neighbors, float[] probabilities, boolean normalized) {
    ...
    private int czzBucketSelect() {
        ...
        return this._neighbors.get(ret);                    //返回索引对应的节点id
    }
    ...
    private int aliasSelect() {
        ...
        return this._neighbors.get(ret);
    }
    ...
    public int getItemRandomly() {
        int ret = -1;
        if (this._algorithm == Algorithm.Alias) {
            ret = aliasSelect();
